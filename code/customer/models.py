...
class User(AbstractUser):
    ...
    personal_id = models.CharField(_('Personal ID'), max_length=11,
                 ...
                 unique=True, blank=False, null=True)
    address = models.OneToOneField(Address, on_delete=models.PROTECT, blank=False, null=True)
    contact = models.OneToOneField(Contact, on_delete=models.PROTECT, blank=False, null=True)
